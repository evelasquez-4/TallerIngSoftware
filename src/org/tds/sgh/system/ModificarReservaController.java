...
public class ModificarReservaController implements IModificarReservaController {
	...
	public ModificarReservaController(CadenaHotelera c) {
	...
	public Set<ReservaDTO> buscarReservasDelCliente() throws Exception {
		// TODO Auto-generated method stub
		Set<Reserva> reservasCliente = this.cliente.buscarReservasCliente(this.cliente.getRut());
		//Set<Reserva> reservasCliente = this.cadenaHotelera.buscarR(this.cliente.getRut());
...
//		reserva =  this.cadenaHotelera.obtenerReservaPorCodigo(codigoReserva);
		reserva =  this.cliente.obtenerReservaPorCondigo(codigoReserva);
	...
	public ReservaDTO modificarReserva(String nombreHotel, String nombreTipoHabitacion, GregorianCalendar fechaInicio,
		...
		// TODO Auto-generated method stub  
		Reserva res = this.cadenaHotelera.modificarReserva(this.hotel.getNombre(),this.cliente.getRut(),this.reserva.getCodigo(),nombreHotel,nombreTipoHabitacion,fechaInicio,fechaFin,modificablePorHuesped);		 
	...
	public Set<HotelDTO> sugerirAlternativas(String pais, String nombreTipoHabitacion, GregorianCalendar fechaInicio,
		...
		// TODO Auto-generated method stub
		Set<Hotel> resl =cadenaHotelera.sugerirAlternativas(pais, nombreTipoHabitacion, fechaInicio, fechaFin);
		return DTO.getInstance().mapHoteles(resl);
	}
